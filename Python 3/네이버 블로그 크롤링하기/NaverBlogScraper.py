...
naver_client_id = "AvuEpygKupqAbqu95oFo"
naver_client_secret = "2oasIMbpxR"

#블로그 검색 결과 개수를 가져옴
#네이버는 최대 1000개의 포스트 결과를 보여주기 때문에 그 이상이면 1000으로 고
    ...
    if response_code is 200:
        ...
        for item_index in range(0, len(response_body_dict['items'])):
            try:
                ...
                link = response_body_dict['items'][item_index]['link'].replace("amd;", "")
                ...
                post_soup = BeautifulSoup(post_text, 'lml')
                ...
                for mainFrame in post_soup.select('iframe#mainFrame'):
                    ...
                    for blog_post_content in blog_post_soup.select('div#postViewArea'):
                        ...
                        blog_post_full_contents = str(blog_post_cont_text)
                        blog_post_full_contents = blog_post_full_contents.replace("/n/n", "/n")
                        #print("blog_post_contents : " + blog_post_full_contents + "/n")
                        fs.write(blog_post_full_contents + "/n")
                        fs.write("━━━━━━━━━━━━━━━━━━/n")
...
if __name__ == '__main__':
    ...
    query = "포켓몬"  #검색을 원하는 문자열로서 UTF-8로 인코딩한다.  여기의 단어를 검색한다.
