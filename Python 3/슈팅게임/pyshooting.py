...
rockImage = ['rock01.png', 'rock02.png', 'rock03.png', 'rock04.png', 'rock05.png', \
             ...
             'rock26.png', 'rock27.png', 'rock28.png', 'rock29.png', 'rock30.png']  #돌의 이미지
...
def initGame():
    ...
    pygame.mixer.music.load('music.wav')  #배경 음
...
def runGame():
    ...
    while not onGame:
        ...
        #미사일 발사 화면에 그리기
        if len(missileXY) != 0:
            for i, bxy in enumerate(missileXY):  #미사일 요쇼에 대해 반복함
        ...
        if isShot:
            #운석 폭팔
            drawObject(explosion, rockX, rockY)  #운석 폭팔 그림
            destroySound.play()
